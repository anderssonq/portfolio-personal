    ...
    constructor(){
        ...
        this.state={
            recognition:[
                         ...
                         {cardTitle:'Fundamentos de CSS3',info:'Formacion Online de CSS3 actual para el modelado estetico y atractivo de paginas web aplicada al HTML5 Moderno.', imgSrc:imgcss},
                         {cardTitle:'Fundamentos de HTML5',info:'Curso de HTML5 para la creacion adecuada de la estructura web.', imgSrc:imghtml},
                         {cardTitle:'Curso de Java',info:'Curso de Java Core para tener nocion de la programacion java Web.', imgSrc:imgjava},
                         {cardTitle:'Curso de JQuery',info:'Formacion de JQuery para la optimizacion de creacion de scripts js en paginas estaticas', imgSrc:imgjjquery},
                         {cardTitle:'Curso de PHP Basico',info:'Formacion basica de PHP para la comprension de Backend Web.', imgSrc:imgphp},
                         {cardTitle:'Curso de Ruby',info:'Curso de basica de Ruby para la comprension del Backend On Rails.', imgSrc:imgruby},
                         {cardTitle:'Fundamentos de SQL Basico',info:'Curso de SQL basico para tener nocion la correcta estructuracion de las bases de datos.', imgSrc:imgsql}]
        }
    }
    ...
    return (
        <div style={contentDivBards}>
                ...
                <div class="card-content">
                    <span class="card-title activator grey-text text-darken-4">{recog.cardTitle} <i class="material-icons right">more_vert</i></span>
                    <p><a href={recog.imgSrc}>Ver imagen</a></p>
                </div>

                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">{recog.cardTitle}<i class="material-icons right">close</i></span>
                    <p>{recog.info}</p>
                </div>
            </div>)
            })}
