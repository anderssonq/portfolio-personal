  ...
  render() {
    ...
    return (
      <div className="contactComponent" style={contactContent}>
        ...
        <form action="https://facebook.us7.list-manage.com/subscribe/post?u=4880a20f277d76b238c7b2efb&amp;id=4749289fb5" method="post" name="mc-embedded-subscribe-form">

          <div className="input-field col s6">
            <i className="material-icons prefix">account_circle</i>
            <input id="icon_prefix" className="validate" type="text" value={this.state.name} name="FNAME" onChange={(e) => { this.setState({ name: e.target.value }); }} />
